...
const SELECT_BUTTON_TO_KEYBOARD="SELECT_BUTTON_TO_KEYBOARD"
...
export const selectButtonToKeyboard=(buttonToKeyboard)=>({type:SELECT_BUTTON_TO_KEYBOARD,buttonToKeyboard})
...
export const setButtonToKeyboard = (buttonToKeyboard) => {
    return(dispatch)=>{(dispatch(selectButtonToKeyboard(buttonToKeyboard)))}
}
