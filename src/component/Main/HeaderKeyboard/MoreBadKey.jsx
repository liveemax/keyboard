...
export const MoreBadKey = ({currentLetter,allText,badLetter, ...props}) => {

    useEffect(()=>{
        if(document.getElementById("zoom")!==null)document.getElementById("zoom").style.transform="scale(1)"
    },[allText[0]])
